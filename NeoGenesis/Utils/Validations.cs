namespace NeoGenesis.Utils
{
    ...
    { 
        ...
        public static string ValidateEmpty(string message)
        {
            while (true)
            {
                Console.Write(message);
        ...
        public static int ValidateInteger(string message, int min = 1, int? max = null)
            {
                while (true)
                {
                    Console.Write(message);
        ...
        public static string ValidateId(string message, int? min = null, int? max = null)
        {
            while (true)
            {
                Console.Write(message); 
